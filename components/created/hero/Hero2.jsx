...
const Hero2 = () => {
  return (
    // <section className="h-[calc(100vh-3rem)] bg-gradient-to-b from-transparent via-transparent to-[#ecedef] dark:to-[#1c1c1c] relative">
    <section className="min-h-[100vh] bg-gradient-to-b from-transparent via-transparent to-[#ecedef] dark:to-[#1c1c1c] relative overflow-hidden">
      ...
      <div className="absolute top-[30%] left-0 z-0 text-[300px] whitespace-nowrap font-bold ">AUTO-NEL AUTO-NEL</div>
      <div></div>
      ...
      <div className="relative w-full h-full">
        ...
        {/* <div className="absolute top-0 left-0 z-0 grid w-full h-full grid-cols-2"> */}
          {/* <div className="relative z-50 col-span-2 lg:col-span-1 ">
            <Image
          ...
          {/* <div className="relative z-10 col-span-2 lg:col-span-1"> */}
            {/* <div className="relative w-full h-full">
              <div className="absolute w-full lg:w-[calc(100%+30%)] h-[20%] lg:bottom-[30%] right-0 flex items-center justify-center lg:bg-neutral-900 ">
                <Icons.logo className="w-5 h-5 lg:w-12 lg:h-12" />
                <span className="text-3xl font-bold lg:text-7xl">Auto-Nel</span>
              </div>
            </div> */}
          {/* </div>   */}
        {/* </div> */}
